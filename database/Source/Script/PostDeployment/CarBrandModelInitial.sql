...
SELECT N'BMW', N'3-Series Gran Turismo' UNION ALL
SELECT N'BMW', N'5-Series Gran Turismo' UNION ALL
...
SELECT N'Great Wall', N'Hover H3' UNION ALL
SELECT N'Great Wall', N'Hover H5' UNION ALL
SELECT N'Great Wall', N'Hover H6' UNION ALL
...
SELECT N'Iveco', N'49-10' UNION ALL
SELECT N'Iveco', N'700-Series' UNION ALL
SELECT N'Iveco', N'Cargo' UNION ALL
...
SELECT N'Jeep', N'Liberty' UNION ALL
...
SELECT N'Saab', N'9-3' UNION ALL
SELECT N'Saab', N'9-5' UNION ALL
...
SELECT N'Volvo', N'FH' UNION ALL
SELECT N'Volvo', N'FMX' UNION ALL
SELECT N'Volvo', N'FM' UNION ALL
SELECT N'Volvo', N'FE' UNION ALL
SELECT N'Volvo', N'FL' UNION ALL
...
SELECT N'ГАЗ', N'27' UNION ALL
SELECT N'ГАЗ', N'31' UNION ALL
SELECT N'ГАЗ', N'32' UNION ALL
SELECT N'ГАЗ', N'33' UNION ALL
SELECT N'ГАЗ', N'53' UNION ALL
...
SELECT N'МАЗ', N'54323' UNION ALL
SELECT N'МАЗ', N'5516' UNION ALL
SELECT N'МАЗ', N'5334' UNION ALL
SELECT N'МАЗ', N'544А08' UNION ALL
SELECT N'МАЗ', N'6317' UNION ALL
...
SELECT N'УАЗ', N'Patriot' UNION ALL
SELECT N'УРАЛ', N'5557'
;
